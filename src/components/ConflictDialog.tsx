...
export const ConflictDialog: React.FC<ConflictDialogProps> = ({
  ...
  return (
    ...
    >
      <Alert
        variant="warning"
        title="This workload was modified by another user"
        isInline
      >
        <ExclamationTriangleIcon style={{ marginRight: '0.5rem' }} />
        <p>
          The workload you are editing has been modified since you started editing.
          If you save now, your changes will overwrite the other user's changes.
        </p>
